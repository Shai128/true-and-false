...
{/* 
    ...
    <Grid container justify="center" alignItems="center">
        <Grid container justify="center">
        <Button onClick={()=>onAccept(SenderInfoName)} color="primary">
        Accept
        </Button>
        </Grid>
...
<Grid container spacing={3} justify="center">
   ...
   <PlayerListAvailable PlayersAvailable = {PlayersAvailable} CurrentUser ={CurrentUser}/>
              ...
              return (
                ...
                <TableRow hover role="checkbox" tabIndex={-1} key={row.email}>
                 ...
                 <Grid container justify="center" alignItems="center">
                  ...
                  <Grid item xs = {2}>
                  <Button variant="contained" color="primary" fullWidth onClick={()=>{handleClickInvitePlayer(row.email,CurrentUser.nickName)}} className={classes.button}>
                  Invite to Game
                    </Button>
                    </Grid>
